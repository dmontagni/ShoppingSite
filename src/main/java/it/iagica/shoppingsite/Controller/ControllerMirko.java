...
//    }
  ...
  public String carrello(@ModelAttribute Item item, Model model) {
    ...
    public String save(@ModelAttribute ("cart") Item oggetto, Model model) {
    ...
    public List<Item> inserisciOggetto(Item oggetto) {
    	  prodotti.add(new Item(1,"0AB1NE","COCOMERO","cocomero estate",3.5));
	...
	private List<Item> getItem(){
        ...
        Item item1 = new Item(1,"0AB1NE","COCOMERO","cocomero estate",3.5);
        Item item2 = new Item(2,"0545NA","BANANA","banana genovese",5.5);
        Item item3 = new Item(3,"BA998J","MELONE","melone indiano",2.5);
